...
- [x] 01-03: Subscription CRUD + dashboard — manual add/edit/delete/archive UI, service logo library (top 150-200 services), category picker, dashboard with monthly total, annual toggle, subscription list sorted by cost, upcoming charges strip (next 5-7 charges by date)

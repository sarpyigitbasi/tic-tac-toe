...
- **Global scope**: `/Users/sarpyigitbasi/Desktop/CLAUDE-CODE/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sarpyigitbasi/Desktop/CLAUDE-CODE/.claude/notes/`)
...
2. Glob `/Users/sarpyigitbasi/Desktop/CLAUDE-CODE/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sarpyigitbasi/Desktop/CLAUDE-CODE/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sarpyigitbasi/Desktop/CLAUDE-CODE/.claude/notes/` — works in any directory
